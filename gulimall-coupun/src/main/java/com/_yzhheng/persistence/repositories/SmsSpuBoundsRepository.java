...
/**
 * Spring Data JPA repository for entity "SmsSpuBounds" <br> 
 * 
 ...
 *
 */
public interface SmsSpuBoundsRepository extends JpaRepository<SmsSpuBounds, Long> {

	// Insert specific finders here 

	//List<SmsSpuBounds> findByXxx(String xxx);

	//List<SmsSpuBounds> findByXxxStartingWith(String xxx);

	//List<SmsSpuBounds> findByXxxContaining(String xxx);

	//List<SmsSpuBounds> findByYyy(BigDecimal yyy);

	//List<SmsSpuBounds> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
