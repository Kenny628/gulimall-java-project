...
/**
 * Spring Data JPA repository for entity "SmsCouponHistory" <br> 
 * 
...
public interface SmsCouponHistoryRepository extends JpaRepository<SmsCouponHistory, Long> {
	...
	//List<SmsCouponHistory> findByXxx(String xxx);

	//List<SmsCouponHistory> findByXxxStartingWith(String xxx);

	//List<SmsCouponHistory> findByXxxContaining(String xxx);

	//List<SmsCouponHistory> findByYyy(BigDecimal yyy);

	//List<SmsCouponHistory> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
