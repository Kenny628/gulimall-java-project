...
/**
 * Spring Data JPA repository for entity "SmsHomeSubject" <br> 
 * 
 ...
 *
 */
public interface SmsHomeSubjectRepository extends JpaRepository<SmsHomeSubject, Long> {

	// Insert specific finders here 

	//List<SmsHomeSubject> findByXxx(String xxx);

	//List<SmsHomeSubject> findByXxxStartingWith(String xxx);

	//List<SmsHomeSubject> findByXxxContaining(String xxx);

	//List<SmsHomeSubject> findByYyy(BigDecimal yyy);

	//List<SmsHomeSubject> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
