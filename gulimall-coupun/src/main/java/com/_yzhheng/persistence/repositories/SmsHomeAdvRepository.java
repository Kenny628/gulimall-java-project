...
/**
 * Spring Data JPA repository for entity "SmsHomeAdv" <br> 
 * 
 ...
 *
 */
public interface SmsHomeAdvRepository extends JpaRepository<SmsHomeAdv, Long> {

	// Insert specific finders here 

	//List<SmsHomeAdv> findByXxx(String xxx);

	//List<SmsHomeAdv> findByXxxStartingWith(String xxx);

	//List<SmsHomeAdv> findByXxxContaining(String xxx);

	//List<SmsHomeAdv> findByYyy(BigDecimal yyy);

	//List<SmsHomeAdv> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
