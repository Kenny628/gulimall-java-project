...
public interface MemberFeignService {
    ...
    @GetMapping("/api/v1/UmsMemberReceiveAddress/address/{memberId}")
    public ResponseEntity<List<MemberAddressVo>> getAddresses(@PathVariable("memberId") Long memberId);

    @GetMapping("/api/v1/UmsMemberReceiveAddress/{id}")
    public ResponseEntity<MemberAddressVo> findById(@PathVariable Long id);
}
