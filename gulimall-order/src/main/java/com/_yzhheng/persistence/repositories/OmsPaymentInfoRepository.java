...
/**
 * Spring Data JPA repository for entity "OmsPaymentInfo" <br> 
 * 
 ...
 *
 */
public interface OmsPaymentInfoRepository extends JpaRepository<OmsPaymentInfo, Long> {

	// Insert specific finders here 

	//List<OmsPaymentInfo> findByXxx(String xxx);

	//List<OmsPaymentInfo> findByXxxStartingWith(String xxx);

	//List<OmsPaymentInfo> findByXxxContaining(String xxx);

	//List<OmsPaymentInfo> findByYyy(BigDecimal yyy);

	//List<OmsPaymentInfo> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
