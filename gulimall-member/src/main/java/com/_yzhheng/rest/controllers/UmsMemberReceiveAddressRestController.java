...
import com._yzhheng.rest.services.UmsMemberReceiveAddressService;

@RestController
@RequestMapping(value = "api/v1/UmsMemberReceiveAddress", produces = MediaType.APPLICATION_JSON_VALUE)
public class UmsMemberReceiveAddressRestController {
	 ...
	 * @param service
	 */
	protected UmsMemberReceiveAddressRestController(UmsMemberReceiveAddressService service) {
		super();
