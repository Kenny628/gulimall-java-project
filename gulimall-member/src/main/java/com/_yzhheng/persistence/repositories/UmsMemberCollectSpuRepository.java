...
/**
 * Spring Data JPA repository for entity "UmsMemberCollectSpu" <br> 
 * 
 ...
 *
 */
public interface UmsMemberCollectSpuRepository extends JpaRepository<UmsMemberCollectSpu, Long> {

	// Insert specific finders here 

	//List<UmsMemberCollectSpu> findByXxx(String xxx);

	//List<UmsMemberCollectSpu> findByXxxStartingWith(String xxx);

	//List<UmsMemberCollectSpu> findByXxxContaining(String xxx);

	//List<UmsMemberCollectSpu> findByYyy(BigDecimal yyy);

	//List<UmsMemberCollectSpu> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
