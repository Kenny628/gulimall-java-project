...
/**
 * Spring Data JPA repository for entity "UmsIntegrationChangeHistory" <br> 
 * 
...
public interface UmsIntegrationChangeHistoryRepository extends JpaRepository<UmsIntegrationChangeHistory, Long> {
	...
	//List<UmsIntegrationChangeHistory> findByXxx(String xxx);

	//List<UmsIntegrationChangeHistory> findByXxxStartingWith(String xxx);

	//List<UmsIntegrationChangeHistory> findByXxxContaining(String xxx);

	//List<UmsIntegrationChangeHistory> findByYyy(BigDecimal yyy);

	//List<UmsIntegrationChangeHistory> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
