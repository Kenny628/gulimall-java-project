...
/**
 * Spring Data JPA repository for entity "UmsGrowthChangeHistory" <br> 
 * 
...
public interface UmsGrowthChangeHistoryRepository extends JpaRepository<UmsGrowthChangeHistory, Long> {
	...
	//List<UmsGrowthChangeHistory> findByXxx(String xxx);

	//List<UmsGrowthChangeHistory> findByXxxStartingWith(String xxx);

	//List<UmsGrowthChangeHistory> findByXxxContaining(String xxx);

	//List<UmsGrowthChangeHistory> findByYyy(BigDecimal yyy);

	//List<UmsGrowthChangeHistory> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
