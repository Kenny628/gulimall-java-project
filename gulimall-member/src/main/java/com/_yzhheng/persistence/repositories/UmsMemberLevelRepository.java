...
/**
 * Spring Data JPA repository for entity "UmsMemberLevel" <br> 
 * 
...
public interface UmsMemberLevelRepository extends JpaRepository<UmsMemberLevel, Long> {
	...
	//List<UmsMemberLevel> findByXxx(String xxx);

	//List<UmsMemberLevel> findByXxxStartingWith(String xxx);

	//List<UmsMemberLevel> findByXxxContaining(String xxx);

	//List<UmsMemberLevel> findByYyy(BigDecimal yyy);

	//List<UmsMemberLevel> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
